...
import de.Herbystar.FakePlayers.CustomClient.CustomClient_1_10_R1;
import net.minecraft.server.v1_10_R1.EntityPlayer;
import net.minecraft.server.v1_10_R1.EnumGamemode;
import net.minecraft.server.v1_10_R1.PlayerInteractManager;

public class CustomPlayer_1_10_R1 extends EntityPlayer {

    public CustomPlayer_1_10_R1(PlayerInteractManager manager, String name, UUID uuid) {
        ...
        playerConnection = new CustomClient_1_10_R1(server, this);
    }
