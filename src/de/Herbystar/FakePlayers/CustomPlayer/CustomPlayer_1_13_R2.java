...
import de.Herbystar.FakePlayers.CustomClient.CustomClient_1_13_R2;
import net.minecraft.server.v1_13_R2.EntityPlayer;
import net.minecraft.server.v1_13_R2.PlayerInteractManager;
import net.minecraft.server.v1_13_R2.EnumGamemode;

public class CustomPlayer_1_13_R2 extends EntityPlayer {

    public CustomPlayer_1_13_R2(PlayerInteractManager manager, String name, UUID uuid) {
        ...
        playerConnection = new CustomClient_1_13_R2(server, this);
    }
