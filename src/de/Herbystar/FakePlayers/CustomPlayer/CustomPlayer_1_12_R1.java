...
import de.Herbystar.FakePlayers.CustomClient.CustomClient_1_12_R1;
...
public class CustomPlayer_1_12_R1 extends EntityPlayer {
    ...
    public CustomPlayer_1_12_R1(PlayerInteractManager manager, String name, UUID uuid) {
        ...
        playerConnection = new CustomClient_1_12_R1(server, this);
    }
