...
import de.Herbystar.FakePlayers.CustomClient.CustomClient_1_13_R1;
import net.minecraft.server.v1_13_R1.EntityPlayer;
import net.minecraft.server.v1_13_R1.PlayerInteractManager;
import net.minecraft.server.v1_13_R1.EnumGamemode;

public class CustomPlayer_1_13_R1 extends EntityPlayer {

    public CustomPlayer_1_13_R1(PlayerInteractManager manager, String name, UUID uuid) {
        ...
        playerConnection = new CustomClient_1_13_R1(server, this);
    }
