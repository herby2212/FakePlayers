...
import de.Herbystar.FakePlayers.CustomClient.CustomClient_1_8_R2;
import net.minecraft.server.v1_8_R2.EntityPlayer;
import net.minecraft.server.v1_8_R2.PlayerInteractManager;
import net.minecraft.server.v1_8_R2.WorldSettings.EnumGamemode;

public class CustomPlayer_1_8_R2 extends EntityPlayer {

    public CustomPlayer_1_8_R2(PlayerInteractManager manager, String name, UUID uuid) {
        ...
        playerConnection = new CustomClient_1_8_R2(server, this);
    }
